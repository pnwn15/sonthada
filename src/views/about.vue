<template>
  <!-- component -->
 <div class="bg-[#F4EFDF] w-full h-full fixed">
  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div id="profile"
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <img class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" src="/gojo.jpg" alt="">

                <h1 class="text-3xl font-bold pt-8 lg:pt-0">Panawat Srimuang</h1>
                ...
                <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                    ...
                    </svg> 55/39 ถ.เปล่งพัฒนา อ.เมือง ต.ในเมือง จ.เพชรบูรณ์ 670000
                </p>
        ...
        <div class="w-full lg:w-2/5 ">
            ...
            <img src="/gojo.jpg" class="rounded-3xl p-3 shadow-2xl w-96 hidden lg:block">
